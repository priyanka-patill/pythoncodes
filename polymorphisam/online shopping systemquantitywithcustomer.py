...
class shoppingcart(customers):
    def billing(self,fa,amount,aa):
        ...
        self.amount=sum(ab)
        return (self.amount)
    def detaillist(self, bill,listofcustomers):
         self.bill=bill
         self.listofcustomers=listofcustomers
         #print(self.listofcustomers)
         #print(self.bill)
         print(" ---------------------------------------------------------------------------------------")
...
while(i<=20):
      ...
      x=[]
      i=i+1
      print(" Welcome to TSEC Shopping Mart---------------------------------")
      ...
      while (True):
          ...
          if choice==1:
              ...
              #print ("To check for the entire customers")
              #v3.detaillist(bill,listofcustomers)
              i=25
              break
